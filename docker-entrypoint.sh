...
if [ "$NODE_TYPE" = "validator" ]; then
  ...
  if ls /home/sipc2/keys/consensus/keystore/* >/dev/null 2>&1; then
    CONS_ADDR_RAW=$(cat /home/sipc2/keys/consensus/keystore/* | jq -r .address)
  ...
  BLS_FLAGS=()
  if [ -d /home/sipc2/keys/bls ]; then
    BLS_FLAGS+=(--blspassword /home/sipc2/keys/password.txt)
      BLS_FLAGS+=(--blswallet /home/sipc2/keys/bls/wallet)
  fi
